...
const CloudWithLightning = () => (
    <div class="element">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 60.7 48.7" style={{enableBackground: 'new 0 0 60.7 48.7'}} xmlSpace="preserve">
            <g id="Cloud_4">
                <g id="White_cloud_4">
