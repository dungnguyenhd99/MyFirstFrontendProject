...
const CloudWithMoon = () => (
    <div class="element">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 60.7 44.4" style={{enableBackground:'new 0 0 60.7 44.4'}} xmlSpace="preserve">
            <g id="Cloud_5">
                <g id="White_cloud_5">
