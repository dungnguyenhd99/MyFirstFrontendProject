...
const ClearNight = () => (
    <div class="element">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30.8 42.5" style={{enableBackground:'new 0 0 30.8 42.5'}} xmlSpace="preserve" height="40px" width="40px">
